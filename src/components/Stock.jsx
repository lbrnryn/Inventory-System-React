...
//                         {parts.map(part => (
//                             <option className="text-capitalize" key={part._id} value={part.name} >{part.name}</option>
//                         ))}
//                     </Form.Select>
//                 </Col>
//                 <Col>
...
//                         {brands.map(brand => <option className="text-capitalize" key={brand._id} value={brand.name}>{brand.name}</option>)}
//                     </Form.Select>
//                 </Col>
//                 <Col>
